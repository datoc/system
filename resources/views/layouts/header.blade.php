...
<html lang="ka-GE">
	<head>
		...
		<script type="text/javascript" src="{{ asset('js/script.js?v=0.6.3') }}"></script>
		...
		<link rel="stylesheet" type="text/css" href="{{ asset('css/style.css?v=0.4.6') }}">
		<script>
	...
	<body>
		...
		<div class="navigation">
			<img src="{{ asset('images/rda-ge.png') }}" style="margin-left: 20px; width: 140px;height:40px;margin-top:5px">
			@auth
